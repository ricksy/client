...
handler_currentTimeChanged(UA_Client *client, UA_UInt32 subId, void *subContext,
    ...
    UA_Double dd= *(UA_Double *) value->value.data;
    UA_LOG_INFO(UA_Log_Stdout, UA_LOGCATEGORY_USERLAND, "current FanSpeed has changed to %f ", dd);
    ...
    switch(clientState) {
        ...
        case UA_CLIENTSTATE_SESSION:{
            ...
            UA_MonitoredItemCreateRequest monRequest =
                UA_MonitoredItemCreateRequest_default(UA_NODEID_STRING(1, "FanSpeed"));
...
main(void) {
    ...
    while(running) {
        ...
        UA_StatusCode retval = UA_Client_connect(client, "opc.tcp://opcuademo.sterfive.com:26543");
